...
public class BioSaidaController {
    ...
    @PostMapping
    public ResponseEntity<Void> registrarSaida(@RequestBody BioSaida bioSaida) {
        if (!StringUtils.isEmpty(bioSaida.getId()))
            this.bioSaidaService.registrarSaida(bioSaida);
